...
class SyncClient:
    ...
    def connect(self, *, subscribe: bool = True) -> None:
        ...
        if self._sock is not None:
            raise ConnectionClosed("SyncClient is single-use; create a new one to reconnect")
    ...
    def set(self, name: str, value: Any, *, compartment: int | None = None) -> WriteExpectation:
